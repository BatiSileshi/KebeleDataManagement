...
class Resident(models.Model):
    ...
    nationality = models.CharField(max_length=100, null=True, blank=True, default="Ethiopian")
...
class BirthCertificate(models.Model):
    ...
    mother = models.ForeignKey(Resident, on_delete=models.CASCADE, null=True, blank=True, limit_choices_to={'sex': 'Female'}, related_name="mothers")
    sex = models.CharField(max_length=20, null=True, blank=True, choices=SAALA)
